    ...
    <a-row class="form-row">
      ...
      <a-col :xl="{span: 8, offset: 2}" :lg="{span: 10}" :md="{span: 24}" :sm="24">
        ...
        >
          ...
          >
            <a-select-option value="Lili Huang">Lili Huang</a-select-option>
            <a-select-option value="Li Da Da">Li Da Da</a-select-option>
          </a-select>
        </a-form-item>
      </a-col>
    </a-row>
      ...
      <a-col :lg="6" :md="12" :sm="24">
        <a-form-item :label="$t('duty')">
          ...
          >
            ...
            <a-select-option value="Li Hongjun">Li Hongjun</a-select-option>
          </a-select>
        </a-form-item>
      </a-col>
      <a-col :xl="{span: 6, offset: 2}" :lg="{span: 8}" :md="{span: 12}" :sm="24">
