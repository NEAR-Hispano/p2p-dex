  ...
  <div ref="table" :id="id" class="advanced-table">
    ...
    <div :class="['header-bar', size]">
      <div class="title">
        ...
        <template v-else>Advanced tables</template>
      </div>
      <div class="search">
  ...
  export default {
    ...
    methods: {
      ...
      inFullScreen() {
        ...
        this.$message.warn("Sorry, your browser doesn't support full-screen mode")
